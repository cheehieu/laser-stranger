...
set APP_RELEASE="..\..\nRF5_SDK_15.0.0_a53641a\examples\ble_peripheral\stranger-things-wall\pca10040\s132\ses\Output\Release\Exe\stranger-things-wall.hex"
set APP_DEBUG="..\..\nRF5_SDK_15.0.0_a53641a\examples\ble_peripheral\stranger-things-wall\pca10040\s132\ses\Output\Debug\Exe\stranger-things-wall.hex"
...
nrfutil settings generate --family NRF52 --application app.hex --application-version 1 --bootloader-version 1 --bl-settings-version 1 bootloader_setting.hex
IF %ERRORLEVEL% NEQ 0 (
  GOTO FLASH_FAIL
)
...
:FLASH_SUCCESS
cscript MessageBox.vbs stranger-things-wall firmware flashing SUCCEEDED!"
exit /b

:FLASH_FAIL
cscript MessageBox.vbs "stranger-things-wall firmware flashing FAILED! Please try again."
